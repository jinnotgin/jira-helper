...
var app = (function () {
    ...
    /* src/DragDropAware.svelte generated by Svelte v3.28.0 */
    const file = "src/DragDropAware.svelte";
    const get_shadow_slot_changes = dirty => ({});
    const get_shadow_slot_context = ctx => ({});

    const get_content_slot_changes = dirty => ({
    	isDragging: dirty & /*isDragging*/ 4,
    	elementWhenMouseIsReleased: dirty & /*elementWhenMouseIsReleased*/ 1
    });

    const get_content_slot_context = ctx => ({
    	isDragging: /*isDragging*/ ctx[2],
    	elementWhenMouseIsReleased: /*elementWhenMouseIsReleased*/ ctx[0]
    });
    ...
    function create_fragment(ctx) {
    	...
    	const shadow_slot_template = /*#slots*/ ctx[7].shadow;
    	const shadow_slot = create_slot(shadow_slot_template, ctx, /*$$scope*/ ctx[6], get_shadow_slot_context);
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			div0 = element("div");
    			if (shadow_slot) shadow_slot.c();
    			attr_dev(div0, "class", "shadow svelte-13h97o6");
    			set_style(div0, "left", /*m*/ ctx[1].x + shadowOffset + "px");
    			set_style(div0, "top", /*m*/ ctx[1].y + shadowOffset + "px");
    			add_location(div0, file, 74, 2, 1625);
    			attr_dev(div1, "class", "dragDropAware svelte-13h97o6");
    			toggle_class(div1, "active", /*isDragging*/ ctx[2]);
    			add_location(div1, file, 65, 0, 1400);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div1, "mousedown", /*handleMousedown*/ ctx[3], false, false, false),
    					listen_dev(div1, "mouseup", /*handleMouseup*/ ctx[5], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (content_slot) {
    				if (content_slot.p && dirty & /*$$scope, isDragging, elementWhenMouseIsReleased*/ 69) {
    					update_slot(content_slot, content_slot_template, ctx, /*$$scope*/ ctx[6], dirty, get_content_slot_changes, get_content_slot_context);
    				}
    			}

    			if (shadow_slot) {
    				if (shadow_slot.p && dirty & /*$$scope*/ 64) {
    					update_slot(shadow_slot, shadow_slot_template, ctx, /*$$scope*/ ctx[6], dirty, get_shadow_slot_changes, get_shadow_slot_context);
    				}
    			}

    			if (!current || dirty & /*m*/ 2) {
    				set_style(div0, "left", /*m*/ ctx[1].x + shadowOffset + "px");
    			}
    		...
    		i: function intro(local) {
    			...
    			transition_in(shadow_slot, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(content_slot, local);
    			transition_out(shadow_slot, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			if (content_slot) content_slot.d(detaching);
    			if (shadow_slot) shadow_slot.d(detaching);
    			mounted = false;
    			run_all(dispose);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_slots("DragDropAware", slots, ['content','shadow']);
    	...
    	function _handleMousedown(event) {
    		...
    		$$invalidate(0, elementWhenMouseIsReleased = null);
    	}
    	...
    	function handleMousemove(event) {
    		if (isMouseDown) {
    			...
    			if (clientX !== m.x && clientY !== m.y) {
    				$$invalidate(10, hasMouseMoved = true);
    			}
    	...
    	function handleMouseup(event) {
    		...
    		$$invalidate(10, hasMouseMoved = false);
    		$$invalidate(0, elementWhenMouseIsReleased = document.elementFromPoint(m.x, m.y));
    		dispatch("mouseReleased", { elementWhenMouseIsReleased });
    	} // console.log(elementWhenMouseIsReleased);

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<DragDropAware> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({
    		...
    		isMouseDown,
    		timeout_longTermMouseDown,
    		longTermMouseDown_delay,
    		_handleMousedown,
    		handleMousedown,
    		hasMouseMoved,
    		m,
    	...
    	$$self.$inject_state = $$props => {
    		if ("elementWhenMouseIsReleased" in $$props) $$invalidate(0, elementWhenMouseIsReleased = $$props.elementWhenMouseIsReleased);
    		if ("isMouseDown" in $$props) $$invalidate(8, isMouseDown = $$props.isMouseDown);
    		if ("timeout_longTermMouseDown" in $$props) timeout_longTermMouseDown = $$props.timeout_longTermMouseDown;
    		if ("hasMouseMoved" in $$props) $$invalidate(10, hasMouseMoved = $$props.hasMouseMoved);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*isMouseDown, hasMouseMoved*/ 1280) {
    			 $$invalidate(2, isDragging = isMouseDown && hasMouseMoved);
    		}
    	};
    ...
    class DragDropAware extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/Card.svelte generated by Svelte v3.28.0 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty & /*urlName*/ 8) set_data_dev(t0, /*urlName*/ ctx[3]);

    			if (!current || dirty & /*url*/ 4) {
    				attr_dev(a, "href", /*url*/ ctx[2]);
    			}

    			if (!current || dirty & /*tooltipText*/ 16) {
    				attr_dev(a, "title", /*tooltipText*/ ctx[4]);
    			}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!current || dirty & /*draggable, selected*/ 320 && div_draggable_value !== (div_draggable_value = /*draggable*/ ctx[8] && /*selected*/ ctx[6])) {
    				attr_dev(div, "draggable", div_draggable_value);
    			}

    			if (dirty & /*type, active*/ 33) {
    				toggle_class(div, "active", /*active*/ ctx[5]);
    			}
    ...
    class Card extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*urlName*/ ctx[3] === undefined && !("urlName" in props)) {
    			console.warn("<Card> was created without expected prop 'urlName'");
    		}

    		if (/*tooltipText*/ ctx[4] === undefined && !("tooltipText" in props)) {
    			console.warn("<Card> was created without expected prop 'tooltipText'");
    		}

    		if (/*active*/ ctx[5] === undefined && !("active" in props)) {
    			console.warn("<Card> was created without expected prop 'active'");
    		}

    		if (/*selected*/ ctx[6] === undefined && !("selected" in props)) {
    			console.warn("<Card> was created without expected prop 'selected'");
    		}

    		if (/*onClick*/ ctx[7] === undefined && !("onClick" in props)) {
    ...
    /* src/NumberInput.svelte generated by Svelte v3.28.0 */
    const file$2 = "src/NumberInput.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "class", "numberInput custom-numberInput svelte-22zk4m");
    			attr_dev(input, "type", "number");
    			attr_dev(input, "step", "any");
    			input.value = /*value*/ ctx[0];
    			add_location(input, file$2, 17, 0, 327);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "keyup", prevent_default(/*onKeyupHandler*/ ctx[1]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const onKeyupHandler = event => {
    		if (event.code == "Enter") {
    			event.preventDefault();
    			dispatch("valueChanged", { value: event.target.value });
    		}
    	};
    ...
    /* src/Hoverable.svelte generated by Svelte v3.28.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			add_location(div, file$3, 19, 0, 302);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (default_slot) {
    				if (default_slot.p && dirty & /*$$scope, hovering*/ 17) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let hovering;
    	let { requireCtrlKey = false } = $$props;
    	...
    	const writable_props = ["requireCtrlKey"];
    	...
    	$$self.$$set = $$props => {
    		if ("requireCtrlKey" in $$props) $$invalidate(3, requireCtrlKey = $$props.requireCtrlKey);
    		if ("$$scope" in $$props) $$invalidate(4, $$scope = $$props.$$scope);
    	};

    	$$self.$capture_state = () => ({ hovering, requireCtrlKey, enter, leave });
    	...
    	return [hovering, enter, leave, requireCtrlKey, $$scope, slots];
    }

    class Hoverable extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { requireCtrlKey: 3 });
    	...
    	get requireCtrlKey() {
    		throw new Error("<Hoverable>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set requireCtrlKey(value) {
    		throw new Error("<Hoverable>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/Divider.svelte generated by Svelte v3.28.0 */
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Divider> was created with unknown prop '${key}'`);
    	});

    	const click_handler = (active, event) => checkValidClick(event, active);
    ...
    /* src/SprintList.svelte generated by Svelte v3.28.0 */

    const { console: console_1$1 } = globals;
    const file$5 = "src/SprintList.svelte";
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*userCanToggleVisibility*/ ctx[4]) {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);

    					if (dirty & /*userCanToggleVisibility*/ 16) {
    			...
    			if (/*userCanToggleVisibility*/ ctx[4] && /*userToggleVisible*/ ctx[6] || !/*userCanToggleVisibility*/ ctx[4]) {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);

    					if (dirty & /*userCanToggleVisibility, userToggleVisible*/ 80) {
    ...
    function create_if_block_1$2(ctx) {
    	...
    	let if_block1 = !/*isSearching*/ ctx[5] && create_if_block_2$1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*items*/ ctx[1].length > 0 && !/*isSearching*/ ctx[5]) {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);

    					if (dirty & /*items, isSearching*/ 34) {
    						transition_in(if_block0, 1);
    					}
    				} else {
    			...
    			if (dirty & /*triggerMoveIssues, items, isSearching, dropped, $selectedIssuesIds, $isMovingIssues, onItemClick, onNumberSubmit*/ 16781742) {
    				...
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, ol, outro_and_destroy_block, create_each_block, t1, get_each_context);
    				check_outros();
    			}

    			if (!/*isSearching*/ ctx[5]) {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);

    					if (dirty & /*isSearching*/ 32) {
    						transition_in(if_block1, 1);
    					}
    				} else {
    		...
    		o: function outro(local) {
    			...
    			if (local) {
    				ol_outro = create_out_transition(ol, slide, {});
    			}
    		...
    		d: function destroy(detaching) {
    			...
    			if (if_block1) if_block1.d();
    			if (detaching && ol_outro) ol_outro.end();
    		}
    	};
    ...
    function create_default_slot_1(ctx) {
    	...
    	numberinput.$on("valueChanged", valueChanged_handler);
    ...
    function create_fragment$5(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*items*/ ctx[1].length > 0 && create_if_block$2(ctx);
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { sprintId } = $$props,
    		...
    		{ items } = $$props,
    		{ onItemClick } = $$props,
    		{ onNumberSubmit } = $$props,
    		{ userCanToggleVisibility } = $$props,
    		{ isSearching } = $$props;
    	...
    	const onToggleClick = () => {
    		if (userCanToggleVisibility) {
    			$$invalidate(6, userToggleVisible = !userToggleVisible);
    		}
    	};
    	...
    	const addItem = (insertAt = "end") => {
    		...
    		dispatch("createNewIssue", { sprintId, title, insertAt });
    	};

    	const triggerMoveIssues = (moveMode, referenceIssueId) => {
    		dispatch("moveIssues", { sprintId, moveMode, referenceIssueId });
    	};
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<SprintList> was created with unknown prop '${key}'`);
    	});

    	const func = () => addItem("start");
    	const func_1 = () => triggerMoveIssues("before", items[0].id);

    	const valueChanged_handler = (item, e) => {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("onNumberSubmit" in $$props) $$invalidate(3, onNumberSubmit = $$props.onNumberSubmit);
    		if ("userCanToggleVisibility" in $$props) $$invalidate(4, userCanToggleVisibility = $$props.userCanToggleVisibility);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("userCanToggleVisibility" in $$props) $$invalidate(4, userCanToggleVisibility = $$props.userCanToggleVisibility);
    		if ("isSearching" in $$props) $$invalidate(5, isSearching = $$props.isSearching);
    		if ("userToggleVisible" in $$props) $$invalidate(6, userToggleVisible = $$props.userToggleVisible);
    	};
    ...
    class SprintList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*header*/ ctx[0] === undefined && !("header" in props)) {
    			console_1$1.warn("<SprintList> was created without expected prop 'header'");
    		}

    		if (/*items*/ ctx[1] === undefined && !("items" in props)) {
    			console_1$1.warn("<SprintList> was created without expected prop 'items'");
    		}

    		if (/*onItemClick*/ ctx[2] === undefined && !("onItemClick" in props)) {
    			console_1$1.warn("<SprintList> was created without expected prop 'onItemClick'");
    		}

    		if (/*onNumberSubmit*/ ctx[3] === undefined && !("onNumberSubmit" in props)) {
    			console_1$1.warn("<SprintList> was created without expected prop 'onNumberSubmit'");
    		}

    		if (/*userCanToggleVisibility*/ ctx[4] === undefined && !("userCanToggleVisibility" in props)) {
    			console_1$1.warn("<SprintList> was created without expected prop 'userCanToggleVisibility'");
    		}

    		if (/*isSearching*/ ctx[5] === undefined && !("isSearching" in props)) {
    			console_1$1.warn("<SprintList> was created without expected prop 'isSearching'");
    		}
    	}

    	get sprintId() {
    		throw new Error("<SprintList>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set sprintId(value) {
    		throw new Error("<SprintList>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    	...
    	set onNumberSubmit(value) {
    		throw new Error("<SprintList>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get userCanToggleVisibility() {
    		throw new Error("<SprintList>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set userCanToggleVisibility(value) {
    		throw new Error("<SprintList>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    const set_IssueEstimate = async (issuedId, estimateValue) => {
    ...
    const set_newIssue = (sprintId, issueName, issueTypeId = "10001") => {
      let FETCH_URL = "";
      switch (MODE) {
        case "DEBUG":
          FETCH_URL = "/";
    ...
    /* src/IssuesList.svelte generated by Svelte v3.28.0 */

    const { console: console_1$2 } = globals;
    const file$6 = "src/IssuesList.svelte";
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	sprintlist = new SprintList({
    			props: {
    				sprintId: /*sprint*/ ctx[14].id,
    				header: /*sprint*/ ctx[14].name,
    				items: /*sprint*/ ctx[14].issues,
    				onItemClick: /*onItemClick*/ ctx[3],
    				onNumberSubmit: /*onNumberSubmit*/ ctx[4],
    				isSearching: /*$activeSearchTerm*/ ctx[2] !== "",
    				userCanToggleVisibility: /*$activeSearchTerm*/ ctx[2] === "" && /*$activeSprintFilter*/ ctx[1] === ""
    			},
    			$$inline: true
    		});

    	sprintlist.$on("createNewIssue", /*onCreateNewIssue*/ ctx[5]);
    	sprintlist.$on("moveIssues", /*onMoveIssues*/ ctx[6]);
    	...
    	const block = {
    		...
    		c: function create() {
    			first = empty();
    			create_component(sprintlist.$$.fragment);
    			t = space();
    			this.first = first;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, first, anchor);
    			mount_component(sprintlist, target, anchor);
    			insert_dev(target, t, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const sprintlist_changes = {};
    			if (dirty & /*sprintIssues*/ 1) sprintlist_changes.sprintId = /*sprint*/ ctx[14].id;
    			if (dirty & /*sprintIssues*/ 1) sprintlist_changes.header = /*sprint*/ ctx[14].name;
    			if (dirty & /*sprintIssues*/ 1) sprintlist_changes.items = /*sprint*/ ctx[14].issues;
    			if (dirty & /*$activeSearchTerm*/ 4) sprintlist_changes.isSearching = /*$activeSearchTerm*/ ctx[2] !== "";
    			if (dirty & /*$activeSearchTerm, $activeSprintFilter*/ 6) sprintlist_changes.userCanToggleVisibility = /*$activeSearchTerm*/ ctx[2] === "" && /*$activeSprintFilter*/ ctx[1] === "";
    			sprintlist.$set(sprintlist_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(sprintlist.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(sprintlist.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(first);
    			destroy_component(sprintlist, detaching);
    			if (detaching) detach_dev(t);
    		}
    	};
    ...
    function create_fragment$6(ctx) {
    	...
    	let each_1_lookup = new Map();
    	let current;
    	let each_value = /*sprintIssues*/ ctx[0];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*sprint*/ ctx[14].id;
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*sprintIssues, onItemClick, onNumberSubmit, $activeSearchTerm, $activeSprintFilter, onCreateNewIssue, onMoveIssues*/ 127) {
    				const each_value = /*sprintIssues*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context$1, get_key);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let $activeIssueId;
    	validate_store(sprints, "sprints");
    	component_subscribe($$self, sprints, $$value => $$invalidate(7, $sprints = $$value));
    	validate_store(issues, "issues");
    	component_subscribe($$self, issues, $$value => $$invalidate(8, $issues = $$value));
    	validate_store(selectedIssuesIds, "selectedIssuesIds");
    	component_subscribe($$self, selectedIssuesIds, $$value => $$invalidate(9, $selectedIssuesIds = $$value));
    	validate_store(activeSprintFilter, "activeSprintFilter");
    	component_subscribe($$self, activeSprintFilter, $$value => $$invalidate(1, $activeSprintFilter = $$value));
    	validate_store(activeSearchTerm, "activeSearchTerm");
    	component_subscribe($$self, activeSearchTerm, $$value => $$invalidate(2, $activeSearchTerm = $$value));
    	validate_store(activeIssueId, "activeIssueId");
    	component_subscribe($$self, activeIssueId, $$value => $$invalidate(11, $activeIssueId = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("IssuesList", slots, []);
    	const dispatch = createEventDispatcher();
    	...
    	const onCreateNewIssue = async event => {
    		...
    		const newIssueKey = lodash.get(result, "issue.issueKey", false);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<IssuesList> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("_$issues" in $$props) $$invalidate(10, _$issues = $$props._$issues);
    		if ("sprintIssues" in $$props) $$invalidate(0, sprintIssues = $$props.sprintIssues);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$issues*/ 256) {
    			 $$invalidate(10, _$issues = $issues);
    		}

    		if ($$self.$$.dirty & /*$sprints, $activeSprintFilter, _$issues, $activeSearchTerm, $activeIssueId, $selectedIssuesIds*/ 3718) {
    			 $$invalidate(0, sprintIssues = $sprints._sequence.filter(sprintId => {
    				const hasSprintFilter = $activeSprintFilter !== "";
    				return !hasSprintFilter || hasSprintFilter && sprintId === $activeSprintFilter;
    			}).map(sprintId => {
    				...
    				const issues = issuesIds.map(issueId => {
    					...
    					const estimate = lodash.get(issue, "estimateStatistic.statFieldValue.text", "");
    					const searchString = `${key} ${summary} ${estimate}`.toLocaleLowerCase().trim();

    					const _hidden = $activeSearchTerm === ""
    					? false
    ...
    class IssuesList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/Search.svelte generated by Svelte v3.28.0 */
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "placeholder", "Search for an issue...");
    			attr_dev(input, "class", "svelte-gwqplq");
    			add_location(input, file$7, 16, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "input", /*handleInput*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ activeSearchTerm, debounce: debounce_1, handleInput });
    	return [handleInput];
    }
    ...
    /* src/IssueBrowser.svelte generated by Svelte v3.28.0 */
    const file$8 = "src/IssueBrowser.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(iframe, "class", "issue-browser svelte-146ddal");
    			if (iframe.src !== (iframe_src_value = /*activeIssueUrl*/ ctx[0])) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "title", "Issue Browser");
    			add_location(iframe, file$8, 24, 0, 444);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*activeIssueUrl*/ 1 && iframe.src !== (iframe_src_value = /*activeIssueUrl*/ ctx[0])) {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	let $activeIssueId;
    	validate_store(issues, "issues");
    	component_subscribe($$self, issues, $$value => $$invalidate(2, $issues = $$value));
    	validate_store(activeIssueId, "activeIssueId");
    	component_subscribe($$self, activeIssueId, $$value => $$invalidate(3, $activeIssueId = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("IssueBrowser", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<IssueBrowser> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("activeIssue" in $$props) $$invalidate(1, activeIssue = $$props.activeIssue);
    		if ("key" in $$props) $$invalidate(4, key = $$props.key);
    		if ("statusUrl" in $$props) $$invalidate(5, statusUrl = $$props.statusUrl);
    		if ("activeIssueUrl" in $$props) $$invalidate(0, activeIssueUrl = $$props.activeIssueUrl);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$issues, $activeIssueId*/ 12) {
    			 $$invalidate(1, activeIssue = lodash.get($issues, `[${$activeIssueId}]`, {}));
    		}

    		if ($$self.$$.dirty & /*activeIssue*/ 2) {
    			 $$invalidate(4, key = lodash.get(activeIssue, "key", false));
    		}

    		if ($$self.$$.dirty & /*activeIssue*/ 2) {
    			 $$invalidate(5, statusUrl = lodash.get(activeIssue, "statusUrl", false));
    		}

    		if ($$self.$$.dirty & /*key, statusUrl*/ 48) {
    			 $$invalidate(0, activeIssueUrl = !!key ? `${statusUrl}browse/${key}` : "");
    		}
    	};

    	return [activeIssueUrl];
    }

    class IssueBrowser extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_each_block$2(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*orderedSprints*/ 1 && t_value !== (t_value = /*sprint*/ ctx[11].name + "")) set_data_dev(t, t_value);

    			if (dirty & /*orderedSprints*/ 1 && option_value_value !== (option_value_value = /*sprint*/ ctx[11].id)) {
    ...
    function create_if_block$3(ctx) {
    	...
    	let issuebrowser;
    	let current;
    	issueslist = new IssuesList({ $$inline: true });
    	issueslist.$on("refreshDataSource", /*refreshDataSource*/ ctx[3]);
    	issuebrowser = new IssueBrowser({ $$inline: true });

    	const block = {
    		c: function create() {
    			section0 = element("section");
    			create_component(issueslist.$$.fragment);
    			t = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(issueslist, section0, null);
    			insert_dev(target, t, anchor);
    			insert_dev(target, section1, anchor);
    			mount_component(issuebrowser, section1, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(issueslist.$$.fragment, local);
    			transition_in(issuebrowser.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(issueslist.$$.fragment, local);
    			transition_out(issuebrowser.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(section0);
    			destroy_component(issueslist);
    			if (detaching) detach_dev(t);
    			if (detaching) detach_dev(section1);
    			destroy_component(issuebrowser);
    		}
    	};
    ...
    function create_fragment$9(ctx) {
    	...
    	let each_value = /*orderedSprints*/ ctx[0];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*sprint*/ ctx[11].id;
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(search, section0, null);
    			...
    			select_option(select, /*$activeSprintFilter*/ ctx[1]);
    			append_dev(main, t2);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*orderedSprints*/ 1) {
    				const each_value = /*orderedSprints*/ ctx[0];
    				validate_each_argument(each_value);
    				validate_each_keys(ctx, each_value, get_each_context$2, get_key);
    			...
    			if (dirty & /*$activeSprintFilter, orderedSprints*/ 3) {
    				select_option(select, /*$activeSprintFilter*/ ctx[1]);
    			}
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	let $ready;
    	validate_store(issues, "issues");
    	component_subscribe($$self, issues, $$value => $$invalidate(7, $issues = $$value));
    	validate_store(sprints, "sprints");
    	component_subscribe($$self, sprints, $$value => $$invalidate(8, $sprints = $$value));
    	validate_store(epics, "epics");
    	component_subscribe($$self, epics, $$value => $$invalidate(9, $epics = $$value));
    	validate_store(activeSprintFilter, "activeSprintFilter");
    	component_subscribe($$self, activeSprintFilter, $$value => $$invalidate(1, $activeSprintFilter = $$value));
    	...
    	const _refreshDataSource = () => {
    		...
    		get_rapidBoard().then(data => {
    			...
    			const process = keyName => {
    				const array = lodash.get(data, keyName, []);
    	...
    	function select_change_handler() {
    		$activeSprintFilter = select_value(this);
    		activeSprintFilter.set($activeSprintFilter);
    		($$invalidate(0, orderedSprints), $$invalidate(8, $sprints));
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("name" in $$props) $$invalidate(4, name = $$props.name);
    		if ("timeout_refreshDataSource" in $$props) timeout_refreshDataSource = $$props.timeout_refreshDataSource;
    		if ("orderedSprints" in $$props) $$invalidate(0, orderedSprints = $$props.orderedSprints);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$sprints*/ 256) {
    			 $$invalidate(0, orderedSprints = $sprints._sequence.filter(id => $sprints[id].issuesIds.length > 0).map(id => $sprints[id]));
    		}
    	};
